...
listOfFilesScanned=pd.read_csv("C:/Users/cinthyavelaochaga/PycharmProjects/pythonProject/Resources/Files_Scanned/ListOfScans.csv")
listOfFilesScanned=pd.DataFrame(listOfFilesScanned)
...
#adding columns name,version,date to list of scanned Records
# listOfFilesScanned.insert(1, "Name", "")
# listOfFilesScanned.insert(2, "Version", "")
# listOfFilesScanned.insert(3, "Date", "")
...
for entry in entries.iterdir():#iterating over the directory
    ...
    if list_files is not listOfFilesScanned:
        listOfFilesScanned=pd.DataFrame(list_files)
